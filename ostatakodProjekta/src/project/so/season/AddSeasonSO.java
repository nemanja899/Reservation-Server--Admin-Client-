 ...
 * @author User
 */
public class AddSeasonSO extends AbstractSO{
    ...
    protected void precondition(Object entity) throws ValidationException {
        ...
        String season=((Season)entity).getSeason();
    ...
    protected Object executeOperation(Object entity, Connection conn) throws Exception {
        try {
            seasonStorrage.add((Season) entity, conn);
            return true;
        } catch (Exception e) {
            throw new Exception("Sezona ne moze da se doda");
        }
    }
